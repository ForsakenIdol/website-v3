  ...
  return (
    <div>
      ...
      <div className={styles.bio} id="bio">
        ...
        <p>This entire website runs in a framework known as Kubernetes, which is an open-source container orchestration system and I've been interested in learning for some time. There are 4 different kinds of pods, each housing a single container representing a different part of the tech stack of this website. With iteration 3, I wanted to focus on building my understanding of web development by shifting from the monolithic architecture of iteration 2, to a microservices architecture for the current iteration. This would help me develop different parts of the stack separately and make it easier to adopt a Kubernetes hosting solution.</p>
